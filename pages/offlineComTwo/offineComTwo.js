...
Page({
    ...
    bindInput(e) {
        let type = e.currentTarget.dataset.type
        let typeArr = ["address", "client", "tel","money"]
        if (type == 0) {
            this.setData({
    ...
    saveData() {
        ...
        console.log(address, client, tel, money)
        ...
        this.submitFile(userid, vocde, targetFile)
            .then((res) => {
                ...
                self.submitAllData(userid, vocde, address, client, tel, arids, money)
                    .then(res => {
                        //wx.hideLoading()
                    })
            })
    ...
    //保存
    submitAllData(userid, vcode, address, client, tel, arids, money) {
